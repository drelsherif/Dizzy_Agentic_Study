#!/usr/bin/env python3
"""
DizzyCTA Agentic Pipeline v13.5.2 — Cleaned for Public Release
=============================================================
...
def detect_mra(text: str) -> tuple[str, str]:
    ...
    if not text or text == 'N/A':
        return 'No', ''
    evidence = _short_matching_sentence(text, _MRA_PATTERN)
    return ('Yes', evidence) if evidence else ('No', '')
